...
$gameinfos = [
    ...
    'game_name' => "Village Pillage",

    // Game publisher (use empty string if there is no publisher)
    'publisher' => 'Jellybean Games',

    // Url of game publisher website
    'publisher_website' => 'http://www.jellybean.games/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 54059,
    ...
    'tie_breaker_description' => "In the case of a tie, the winner is the person with the most turnips, then most cards in hand.",
